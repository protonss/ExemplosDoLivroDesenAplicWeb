      ...
      <f:view>
            ...
            <h:form>
              <h:commandLink 
               ...
               <h:commandLink action="#{livrosView.primeiraPagina}" 
                value="Primeira" 
                rendered="#{livrosView.paginaAtual!=0}"/>&nbsp;    		
                <h:commandLink action="#{livrosView.anterior}" 
                value="Anterior" 
                rendered="#{livrosView.paginaAtual!=0}"/>&nbsp;
                <h:commandLink action="#{livrosView.proxima}" 
                value="Proxima" 
                rendered="#{livrosView.proximaPagina< livrosView.total}"/>&nbsp;
 
               <h:commandLink action="#{livrosView.ultimaPagina}" 
                value="Última" 
                rendered="#{livrosView.proximaPagina< livrosView.total}"/>&nbsp;
